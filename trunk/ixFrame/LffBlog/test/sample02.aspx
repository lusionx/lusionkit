<%@ Page Language="C#" AutoEventWireup="True" Inherits="WebApplication1.sample02"
    CodeBehind="sample02.aspx.cs" %>
...
<body>
    ...
    <div id="PostedDataBlock" runat="server" visible="false">
        ...
        <pre>
<asp:Label ID="LblPostedData" runat="server"></asp:Label></pre>
    </div>
    </form>
    <div id="ccc">
    </div>
