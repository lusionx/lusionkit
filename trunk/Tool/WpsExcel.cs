...
namespace Tool
{
    public class WpsExcel : IExcel
    {
        ...
        public WpsExcel(string TemplatePath)
        {
            _book = _app.Workbooks.Open(TemplatePath, miss, miss, miss, miss, miss, miss, miss, miss, miss, miss, miss, miss);
            CurrentSheet = (Worksheet)_book.ActiveSheet;
        }
        ...
        {
            _book.SaveAs(path, miss, miss, miss, miss, miss, ETSaveAsAccessMode.etExclusive, miss, miss, miss, miss);
        }

        public void InsertPicture(string RangeName, string PicturePath)
        {
            throw new System.ArgumentException("不支持图片插入");
        }
