<html>
    ...
    <body><h1>Welcome to CodeIgniter!</h1>
        ...
        <code>system/application/views/welcome_message.php
        </code>
        <p>The corresponding controller for this page is found at:
        </p>
        <code>system/application/controllers/welcome.php
        </code>
        <p>If you are exploring CodeIgniter for the very first time, you should start by reading the
            <a href="user_guide/" target="_blank">User Guide(local,en)</a>.
        </p>
        <p>
            <a href="user_guide_local_cn/" target="_blank">文档(中文,本地)</a>.
        </p>
        <p>
            <a href="http://codeigniter.org.cn/user_guide/" target="_blank">文档(中文,网络)</a>.
        </p>
